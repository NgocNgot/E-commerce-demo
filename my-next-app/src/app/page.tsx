    ...
    <>
      ...
      <section className="text-center py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6 container mx-auto px-6">
          {products.length > 0 ? (
            products
              .filter(product => product.slug !== "liceria-beauty-skincare") // Filter out the "liceria-beauty-skincare" product
              .map((product) => (
                <div
                ...
                >
                  ...
                  <div className="bg-white pt-4 pb-4 transition-transform hover:scale-105 relative">
                    ...
                    {/* Add to cart */}
                    <button
                      className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 bg-rose-500 text-white text-base shadow-lg px-4 py-2 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-2"
                    >
