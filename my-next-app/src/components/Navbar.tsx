...
//             </li>
//             <li>
//               <Link href="#" className="hover:text-rose-400">Shop</Link>
//             </li>
//             <li>
//               <Link href="#" className="hover:text-rose-400">Blog</Link>
//             </li>
//             <li>
//               <Link href="#" className="hover:text-rose-400">Product</Link>
//             </li>
//             <li>
//               <Link href="#" className="hover:text-rose-400">Sale</Link>
//             </li>
//           </ul>
//         </div>
...
//           </Link>
//           <Link href="/cart" className="text-gray-600 hover:text-rose-400 relative">
