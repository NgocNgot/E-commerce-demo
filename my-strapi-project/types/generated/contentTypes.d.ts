...
export interface ApiInventoryInventory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    continueSelling: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hasSKU: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPricingPricing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chargeTax: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    compareAtPrice: Schema.Attribute.Decimal;
    costPerItem: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductOrganizationProductOrganization
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_organizations';
  info: {
    displayName: 'Product Organization';
    pluralName: 'product-organizations';
    singularName: 'product-organization';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    checkouts: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
